...
class User(AbstractUser):
    ...
    fav_book_cat = models.ForeignKey("categories.Category", on_delete=models.SET_NULL, null=True,
                                     related_name="book_users")
    fav_movie_cat = models.ForeignKey("categories.Category", on_delete=models.SET_NULL, null=True,
